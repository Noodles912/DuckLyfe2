...
/**
 * Represents the third tutorial screen in the DuckLyfe2 application.
 * <br><br>
 * This class provides the layout and functionality for the third tutorial screen,
...
public class Tutorial3 {
    ...
    /**
     * Constructs the Tutorial3 screen and initializes its UI components.
     * <br><br>
     * This constructor sets up the navigation buttons, background image, and layout
     * for the third tutorial screen.
     *
     ...
     */
    public Tutorial3(Main main, Duck duck, Inventory inventory, GameSettingsAndStats settings) {
        // Create navigation buttons
        Button backButton = new Button("Back");
        backButton.setOnAction(e -> {
            Tutorial2 tutorial2 = new Tutorial2(main, duck, inventory, settings);
            main.setScene(tutorial2.getScene());
        });

        Button nextButton = new Button("Next");
        nextButton.setOnAction(e -> {
            Tutorial4 tutorial4 = new Tutorial4(main, duck, inventory, settings);
            main.setScene(tutorial4.getScene());
        });
        ...
        Image backgroundImage = new Image("file:src/assets/tutorialScreens/tutorial3.png");
    ...
    /**
     * Retrieves the scene associated with the third tutorial screen.
     * <br><br>
     * This method returns the JavaFX Scene object that represents the third tutorial screen.
     *
     * @return The Scene object for the third tutorial screen.
     */
